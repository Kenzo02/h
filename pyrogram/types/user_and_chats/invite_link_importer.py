...
class InviteLinkImporter(ChatJoiner):
    """The date and user of when someone has joined with an invite link.

    This compatibility type retains the historical ``date``/``user``
    constructor. Current invite-link parser paths return
    :obj:`~pyrogram.types.ChatJoiner` instances.
